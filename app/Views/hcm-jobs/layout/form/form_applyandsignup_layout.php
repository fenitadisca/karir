...
<body id="kt_body" data-bs-spy="scroll" data-bs-target="#kt_landing_menu" data-bs-offset="200"
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <script src="{THEMES_PAGE}/assets/js/custom/authentication/sign-in/general_apply.js"></script>
        <script src="{THEMES_PAGE}/assets/js/custom/documentation/forms/dropzonejs.js"></script>
