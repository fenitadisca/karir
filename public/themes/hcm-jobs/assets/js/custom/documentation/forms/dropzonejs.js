...
var KTFormsDropzoneJSDemos = {
  init: function (e) {
    new Dropzone("#kt_dropzonejs_example_1", {
      url: "http://localhost/hcm-imageserver/public/api",
      paramName: "file",
      maxFiles: 10000,
      maxFilesize: 10000,
      addRemoveLinks: !0,
      ...
      (function () {
        var e = "#kt_dropzonejs_example_2",
          o = $(e + " .dropzone-item");
        o.id = "";
        var n = o.parent(".dropzone-items").html();
        o.remove();
        var r = new Dropzone(e, { url: "https://keenthemes.com/scripts/void.php", parallelUploads: 20, previewTemplate: n, maxFilesize: 1, autoQueue: !1, previewsContainer: e + " .dropzone-items", clickable: e + " .dropzone-select" });
      ...
      (function () {
        var e = "#kt_dropzonejs_example_3",
          o = $(e + " .dropzone-item");
        o.id = "";
        var n = o.parent(".dropzone-items").html();
        o.remove();
        var r = new Dropzone(e, { url: "https://keenthemes.com/scripts/void.php", parallelUploads: 20, maxFilesize: 1, previewTemplate: n, previewsContainer: e + " .dropzone-items", clickable: e + " .dropzone-select" });
        r.on("addedfile", function (o) {
          $(document)
            .find(e + " .dropzone-item")
            .css("display", "");
