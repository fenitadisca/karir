...
var KTSignupGeneral = (function () {
  ...
  return {
    init: function () {
      (e = document.querySelector("#kt_modal_new_address_form")),
        (t = document.querySelector("#kt_modal_new_address_submit")),
        (s = KTPasswordMeter.getInstance(e.querySelector('[data-kt-password-meter="true"]'))),
        (a = FormValidation.formValidation(e, {
          fields: {
            nama_depan: { validators: { notEmpty: { message: "First Name is required" } } },
            nama_belakang: { validators: { notEmpty: { message: "Last Name is required" } } },
                ...
                ? (t.setAttribute("data-kt-indicator", "on"),
                  ...
                  setTimeout(function () {
                    t.removeAttribute("data-kt-indicator"),
                      (t.disabled = !1),
                      Swal.fire({ text: "You have successfully reset your password!", icon: "success", buttonsStyling: !1, confirmButtonText: "Ok, got it!", customClass: { confirmButton: "btn btn-primary" } }).then(function (t) {
